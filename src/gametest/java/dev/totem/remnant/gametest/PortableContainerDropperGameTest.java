...
public final class PortableContainerDropperGameTest {
    ...
    public void dropperCannotInsertBackpackIntoShulker(GameTestHelper helper) {
        ...
        dropper.setItem(0, new ItemStack(RemnantItemRegistration.BACKPACK_ADVANCED));
        helper.setBlock(POWER_POS, Blocks.REDSTONE_BLOCK);

        helper.runAtTickTime(12, () -> {
            require(helper, dropper.getItem(0).is(RemnantItemRegistration.BACKPACK_ADVANCED),
                    "Dropper removed the rejected backpack");
