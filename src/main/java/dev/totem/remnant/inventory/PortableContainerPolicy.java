 ...
 *
 * <p>Legacy invalid contents remain readable and removable. Callers apply this policy only to
 * new insertion and transfer attempts, so loading an old world never deletes or rewrites items.</p>
 */
