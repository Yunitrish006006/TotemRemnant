...
import dev.totem.remnant.inventory.ContainerNestingDiagnostics.Finding;
...
/** Registers the read-only administrator report for legacy invalid nesting. */
public final class ContainerSafetyAdmin {
    private static final int CHAT_FINDING_LIMIT = 20;

    private ContainerSafetyAdmin() {
    }
